...
"}")
        ...
        self.main_graph.setMinimumSize(QtCore.QSize(590, 530))
        ...
        self.led_faster_label = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.led_faster_label.sizePolicy().hasHeightForWidth())
        self.led_faster_label.setSizePolicy(sizePolicy)
        self.led_faster_label.setMaximumSize(QtCore.QSize(300, 20))
        self.led_faster_label.setStyleSheet("color:#dedede")
        self.led_faster_label.setObjectName("led_faster_label")
        self.horizontalLayout_8.addWidget(self.led_faster_label)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.disconnect_powermeter_btn, 0, 2, 1, 1)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.connect_powermeter_btn, 0, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_n_across, 5, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.step_across_beam_n, 4, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.step_across_beam, 2, 2, 1, 1)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.led_faster_label.setText(_translate("MainWindow", "Ускоренное измерение"))
        ...
        self.label.setText(_translate("MainWindow", "Длина шага по оси Y, мм"))
        self.label_6.setText(_translate("MainWindow", "Количество шагов по оси Y"))
        self.label_7.setText(_translate("MainWindow", "Количество шагов по оси X"))
        self.label_2.setText(_translate("MainWindow", "Длина шага по оси X, мм"))
        self.label_4.setText(_translate("MainWindow", "Уровень"))
        self.label_5.setText(_translate("MainWindow", "Диаметр, мм"))
        self.label_8.setText(_translate("MainWindow", "Длина волны, нм"))
