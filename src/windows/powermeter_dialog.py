...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(20, 110, 264, 102))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.rescan_btn.setText(_translate("Dialog", "Обновить"))
        self.label_3.setText(_translate("Dialog", "Скорость передачи данных (Baud rate)"))
