...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QtCore.QRect(1010, 10, 281, 317))
        ...
        self.connect_translator_btn = QtWidgets.QPushButton(self.widget)
        ...
        self.disconnect_translator_btn = QtWidgets.QPushButton(self.widget)
        ...
        self.reverse_x_btn = QtWidgets.QPushButton(self.widget)
        ...
        self.xy_change_btn = QtWidgets.QPushButton(self.widget)
        ...
        self.reverse_y_btn = QtWidgets.QPushButton(self.widget)
        ...
        self.shift_x_line = QtWidgets.QLineEdit(self.widget)
        self.shift_x_line.setObjectName("shift_x_line")
        self.gridLayout.addWidget(self.shift_x_line, 2, 0, 1, 1)
        self.move_x_btn = QtWidgets.QPushButton(self.widget)
        ...
        self.shift_y_line = QtWidgets.QLineEdit(self.widget)
        self.shift_y_line.setObjectName("shift_y_line")
        self.gridLayout.addWidget(self.shift_y_line, 2, 2, 1, 2)
        self.move_y_btn = QtWidgets.QPushButton(self.widget)
        ...
        self.disconnect_powermeter_btn = QtWidgets.QPushButton(self.widget)
        ...
        self.step_along_beam = QtWidgets.QLineEdit(self.widget)
        self.step_along_beam.setObjectName("step_along_beam")
        self.gridLayout_2.addWidget(self.step_along_beam, 2, 1, 1, 1)
        self.step_along_beam_n = QtWidgets.QLineEdit(self.widget)
        ...
        self.step_across_beam = QtWidgets.QLineEdit(self.widget)
        ...
        self.label_n_along = QtWidgets.QLabel(self.widget)
        ...
        self.label_n_across = QtWidgets.QLabel(self.widget)
        ...
        self.step_across_beam_n = QtWidgets.QLineEdit(self.widget)
        ...
        self.connect_powermeter_btn = QtWidgets.QPushButton(self.widget)
...
"")
        ...
        self.begin_measurment_btn = QtWidgets.QPushButton(self.widget)
